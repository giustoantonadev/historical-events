...
<div class="container py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="fw-bold text-light">
                <i class="bi bi-pencil-square me-2"></i> Modifica Evento Storico
            </h1>
            <p class="text-light opacity-75">
                Aggiorna le informazioni dell'evento selezionato.
            </p>
        </div>
    ...
    <div class="card bg-dark border-0 shadow-lg rounded-4">
        <div class="card-body p-4">
            ...
            <form action="{{ route('events.update', $historicalEvent->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <button type="submit" class="btn btn-warning btn-lg w-100 mt-4">
                    <i class="bi bi-check-circle me-2"></i> Aggiorna Evento
                </button>
