                            ...
                            <div class="tab-content p-3 bg-secondary rounded-3">
                                <div class="tab-pane fade show active" id="it-person" role="tabpanel" aria-labelledby="it-person-tab">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name_it" value="{{ old('name_it', $historicalPerson->name_it) }}" class="form-control bg-dark text-light border-0">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-light fw-bold">Biografia (IT)</label>
                                        <textarea name="biography_it" rows="4" class="form-control bg-dark text-light border-0">{{ old('biography_it', $historicalPerson->biography_it) }}</textarea>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="en-person" role="tabpanel" aria-labelledby="en-person-tab">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name_en" value="{{ old('name_en', $historicalPerson->name_en) }}" class="form-control bg-dark text-light border-0">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-light fw-bold">Biography (EN)</label>
                                        <textarea name="biography_en" rows="4" class="form-control bg-dark text-light border-0">{{ old('biography_en', $historicalPerson->biography_en) }}</textarea>
                                    </div>
                                </div>
                                <div class="tab-pane fade" id="fr-person" role="tabpanel" aria-labelledby="fr-person-tab">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="name_fr" value="{{ old('name_fr', $historicalPerson->name_fr) }}" class="form-control bg-dark text-light border-0">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label text-light fw-bold">Biographie (FR)</label>
                                        <textarea name="biography_fr" rows="4" class="form-control bg-dark text-light border-0">{{ old('biography_fr', $historicalPerson->biography_fr) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
