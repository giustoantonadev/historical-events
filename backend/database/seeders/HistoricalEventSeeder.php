    ...
    public function run(): void
    {
        $events = [
            ...
            [
                ...
                'image' => 'events/scoperta-america.jpg',
            ...
            [
                ...
                'year' => 1500,
                'period_id' => Period::where('name', 'Rinascimento')->first()->id,
                'image' => 'events/rinascimento-italiano.jpg',
            ...
            [
                ...
                'year' => 1512,
                'period_id' => Period::where('name', 'Rinascimento')->first()->id,
                'image' => 'events/cappella-sistina.jpg',
                'people' => ['Michelangelo']
            ],
            [
                'title' => 'Ultima Cena',
            ...
            [
                ...
                'year' => 1505,
                'period_id' => Period::where('name', 'Rinascimento')->first()->id,
                'image' => 'events/macchina-volante.jpg',
                'people' => ['Leonardo da Vinci']
            ],
            ...
            [
                ...
                'image' => 'events/invenzione-telescopio.jpg',
            ...
            [
                ...
                'year' => 1610,
                'period_id' => Period::where('name', 'Età Moderna')->first()->id,
                'image' => 'events/satelliti-di-giove.jpg',
                'people' => ['Galileo Galilei']
            ],
            [
                ...
                'year' => 1798,
                'period_id' => Period::where('name', 'Età Moderna')->first()->id,
                'image' => 'events/campagna-egitto.jpg',
            ...
            [
                ...
                'year' => 1815,
                'period_id' => Period::where('name', 'Età Moderna')->first()->id,
                'image' => 'events/battaglia-waterloo.jpg',
                'people' => ['Napoleone Bonaparte']
            ],
            ...
            [
                ...
                'image' => 'events/fondazione-roma.jpg',
                'people' => ['Romolo']
            ],
            [
                ...
                'year' => -44,
                'period_id' => Period::where('name', 'Antichità')->first()->id,
                'image' => 'events/assassinio-giulio-cesare.jpg',
            ...
            [
                ...
                'year' => -330,
                'period_id' => Period::where('name', 'Antichità')->first()->id,
                'image' => 'events/campagne-alessandro-magno.jpg',
            ...
            [
                ...
                'year' => -51,
                'period_id' => Period::where('name', 'Antichità')->first()->id,
                'image' => 'events/regno-cleopatra.jpg',
                'people' => ['Cleopatra']
            ],
            [
                ...
                'year' => -52,
                'period_id' => Period::where('name', 'Antichità')->first()->id,
                'image' => 'events/battaglia-alesia.jpg',
                'people' => ['Giulio Cesare']
            ],
            [
                ...
                'year' => -331,
                'period_id' => Period::where('name', 'Antichità')->first()->id,
                'image' => 'events/fondazione-alessandria.jpg',
                'people' => ['Alessandro Magno']
            ],
            ...
            [
                ...
                'image' => 'events/scoperta-relativita.jpg',
            ...
            [
                ...
                'year' => 1915,
                'period_id' => Period::where('name', 'Età Contemporanea')->first()->id,
                'image' => 'events/relativita-generale.jpg',
                'people' => ['Albert Einstein']
            ],
            [
                ...
                'year' => 1940,
                'period_id' => Period::where('name', 'Età Contemporanea')->first()->id,
                'image' => 'events/seconda-guerra-mondiale.jpg',
            ...
            [
                ...
                'year' => 1940,
                'period_id' => Period::where('name', 'Età Contemporanea')->first()->id,
                'image' => 'events/battaglia-inghilterra.jpg',
                'people' => ['Winston Churchill']
            ],
            ...
            [
                ...
                'image' => 'events/coronazione-carlo-magno.jpg',
                'people' => ['Carlo Magno']
            ],
            [
                ...
                'year' => 1066,
                'period_id' => Period::where('name', 'Medioevo')->first()->id,
                'image' => 'events/battaglia-hastings.jpg',
            ...
            [
                ...
                'year' => 1099,
                'period_id' => Period::where('name', 'Medioevo')->first()->id,
                'image' => 'events/prima-crociata.jpg',
